...
@Component({
  selector: 'app-s3-c4-component',
  templateUrl: './s3-c4-component.component.html',
  styleUrls: ['./s3-c4-component.component.css']
})
export class S3C4ComponentComponent implements OnInit,OnChanges,DoCheck,AfterContentInit,AfterContentChecked,
